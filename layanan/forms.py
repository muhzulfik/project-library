...
class catalogForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'jumlah_buku' : forms.TextInput({'class':'form-control', 'type':'search', 'name':'jumlah_buku', 'placeholder':'Jumlah Buku', 'id':'jumlah_buku'}),
...
class journalForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'issn' : forms.TextInput({'class':'form-control', 'type':'search','name':'issn', 'placeholder':'ISSN'}),
            ...
            'tahun' : forms.TextInput({'class':'form-control', 'type':'search','name':'tahun', 'placeholder':'Tahun'}),
